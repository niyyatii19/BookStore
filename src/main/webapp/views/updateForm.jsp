...
<body>
	...
	<div class="container addPadding">
		...
		<form class="row g-3" method="POST"  enctype=”multipart/form-data” >
			...
			<div class="col-md-6">
				<label class="form-label">Author Id</label> <input type="text"
					class="form-control" id="authorName" name="author.id" value = "${book.author.id }" readonly= "readonly">
			</div>
			<div class="col-md-6">
				<label class="form-label">Author Name</label> <input type="text"
					class="form-control" id="authorName" name="author.name" value = "${book.author.name }" required>
			</div>
			<div class="col-12">
				<label class="form-label">Book Description</label>
				<textarea type="text" class="form-control" id="description"  rows = 2 name = "description"  required> ${book.description } </textarea>
			</div>
			
			<div class="col-md-6">
				<label  class="form-label">Author Country</label> <input
					type="text" class="form-control" id="country" name= "author.country" value = "${book.author.country }" required>
			</div>
			
			<div class="col-md-6">
				<label class="form-label">Add photo</label> 
				<input class="form-control" type="text" name="url" accept="image/png, image/jpg" value= "${book.url }"/>
			</div>
